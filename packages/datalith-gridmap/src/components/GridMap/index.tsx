...
export class GridMapComponent extends React.Component<GridMapProps> {
...
export const GridMap: React.ComponentType<Partial<Props>> = ResponsiveWrapper(GridMapComponent)
