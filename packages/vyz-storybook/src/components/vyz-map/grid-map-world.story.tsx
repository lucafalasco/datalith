...
import { GridMapWorld } from 'vyz-map/src/components/GridMapWorld'
import notes from 'vyz-map/src/components/GridMapWorld/README.md'
...
storiesOf('vyz-map/GridMapWorld', module)
  .addParameters({ notes })
  .add('custom - cross', () => {
